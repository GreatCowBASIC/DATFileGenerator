...
#DEFINE kINDEX_IDX      "C:\Program Files\Microchip\MPLABX\v5.50\packs"
...
Declare Sub PopulateConfig ( SourceFolder as string, Version as string, Chip as string )
  ...
  Else
    ...
    Print "; " + fsp_ini
    print "; " + kINDEX_IDX+"\Microchip\"+chipparameters(3)+"_DFP\"+chipparameters(1)+"\edc\PIC"+ Chip  +".PIC"
        ...
        If DataSource <> "" and left( datasource, 4 ) = "SFR=" Then
            ...
            if FoundRegistersToBeIgnored = 0 then
                ...
                with SFRData(SFRDataCount)
                    ...
                    ThisBank = int(val("&h"+trim(.RegisterAddresss))/127)
