...
gawk -f preprocessIncFile.awk incfiles\OrgFiles\p18F05Q41.inc > incfiles\p18F05Q41.inc
gawk -f preprocessIncFile.awk incfiles\OrgFiles\p18F06Q41.inc > incfiles\p18F06Q41.inc
