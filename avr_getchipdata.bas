...
Declare FUNCTION GPR16Check (FileName As String, Device As String ) as Integer
...
FOR CurrentChip = StartChip to ChipCount
  ...
  If ThisChipData <> "" Then
    ...
    If ChipGPR = -1 Then ChipGPR = VAL(TempData)
    TempData = Mid(TempData, INSTR(TempData, ",") + 1)

    If ChipPinsRaw = -1 Then ChipPinsRaw = VAL(TempData)
    TempData = Mid(TempData, INSTR(TempData, ",") + 1)



    If ChipUSART = -1 Then ChipUSART = VAL(TempData)
    TempData = Mid(TempData, INSTR(TempData, ",") + 1)
...
'    Consume theprint "3 "+ChipPackageList ADC value
  ...
  End If
    ...
    PRINT #1, "'Header Format last revised: 04/02/2020"
    PRINT #1, ""

    Print #1, "[ChipData]"
    Print #1, "Prog=" + Str(ChipWords * 512) ' Input generally in kBytes, GCBASIC uses Words
    if ChipEEPROMRaw <> ChipEEPROM and ThisChipData<>"" then
        Print #1, "EEPROM=" + Str(ChipEEPROMRAW)
    else
    ...
    If ChipPinsRaw <> -1 then
      Print #1, "Pins=" + Str(ChipPinsRaw)
    else
      Print #1, "Pins=" + Str(ChipPins)
    end if

    Print #1, "USART=" + Str(ChipUSART)

    if ChipFamilyOveride > 100 then
...
Function GetBitName (IntVect As String) As String
    ...
    BitName = ""
    Select Case trIm(UCASE(IntVect))
      ...
      Case "WDT:", "WDT", "WDT_OVERFLOW", "WATCHDOG":
            ...
            Else
                ...
                FlagName = "WDIF"
            End If
           'removed  FlagName = "-" so, not sure what this does.... 29.06.2020
      '    FlagName = "-"
          ...
          Select Case PackagePins
              ...
              Case 20
                ...
                If ChipFamily = 121 then
                  AddIOPin(.PinList(), 1, "PCINT4")
                  AddIOPin(.PinList(), 2, "PCINT3")
                  AddIOPin(.PinList(), 3, "PCINT2")
                  AddIOPin(.PinList(), 4, "PCINT1")
                  AddIOPin(.PinList(), 5, "PCINT0")
                  AddIOPin(.PinList(), 6, "DNC")
                  AddIOPin(.PinList(), 7, "DNC")
                  AddIOPin(.PinList(), 8, "GND")
                  AddIOPin(.PinList(), 9, "VCC")
                  AddIOPin(.PinList(), 10, "DNC")
                  AddIOPin(.PinList(), 11, "PCINT8")
                  AddIOPin(.PinList(), 12, "PCINT9")
                  AddIOPin(.PinList(), 13, "PCINT11")
                  AddIOPin(.PinList(), 14, "PCINT10")
                  AddIOPin(.PinList(), 15, "PCINT7")
                  AddIOPin(.PinList(), 16, "PCINT7")
                  AddIOPin(.PinList(), 17, "PCINT5")
                  AddIOPin(.PinList(), 18, "DNC")
                  AddIOPin(.PinList(), 19, "DNC")
                  AddIOPin(.PinList(), 20, "DNC")

                  AddPinFunction(13, "RESET", "I")
                  AddPinFunction(11, "TPISCK", "IO")
                  AddPinFunction(12, "TPIDATA", "IO")

                   AddPinFunction(5, "ADC0", "I")
                   AddPinFunction(4, "ADC1", "I")
                   AddPinFunction(3, "ADC2", "I")
                   AddPinFunction(2, "ADC3", "I")
                   AddPinFunction(1, "ADC4", "I")
                   AddPinFunction(17, "ADC5", "I")
                   AddPinFunction(16, "ADC6", "I")
                   AddPinFunction(15, "ADC7", "I")


                  If ChipADC = 5 then
                       AddPinFunction(2, "ADC0", "I")
                       AddPinFunction(3, "ADC1", "I")
                       AddPinFunction(5, "ADC5", "I")
                       AddPinFunction(6, "ADC6", "I")
                       AddPinFunction(7, "ADC7", "I")
                  End if
              End if
          ...
          With Pinouts(PinoutCount)
            ...
            Select Case PackagePins
              ...
              Case 6
                ...
                If ChipFamily = 121 and PackageName = "SOIC" then
                  AddIOPin(.PinList(), 1, "PB0")
                  AddIOPin(.PinList(), 2, "GND")
                  AddIOPin(.PinList(), 3, "PB1")
                  AddIOPin(.PinList(), 4, "PB2")
                  AddIOPin(.PinList(), 5, "VCC")
                  AddIOPin(.PinList(), 6, "PB3")

                  AddPinFunction(6, "RESET", "I")
                  AddPinFunction(3, "TPISCK", "IO")
                  AddPinFunction(1, "TPIDATA", "IO")

                  AddPinFunction(1, "ADC0", "I")
                  AddPinFunction(3, "ADC1", "I")
                  AddPinFunction(4, "ADC2", "I")
                  AddPinFunction(6, "ADC3", "I")

                end if

                If ChipFamily = 121 and PackageName = "UDFN" then
                  AddIOPin(.PinList(), 1, "PB0")
                  AddIOPin(.PinList(), 2, "NC")
                  AddIOPin(.PinList(), 3, "NC")
                  AddIOPin(.PinList(), 4, "GND")
                  AddIOPin(.PinList(), 5, "PB0")
                  AddIOPin(.PinList(), 6, "PB3")
                  AddIOPin(.PinList(), 6, "VCC")
                  AddIOPin(.PinList(), 8, "PB2")


                  AddPinFunction(6, "RESET", "I")
                  AddPinFunction(1, "TPISCK", "IO")
                  AddPinFunction(5, "TPIDATA", "IO")

                  AddPinFunction(1, "ADC1", "I")
                  AddPinFunction(5, "ADC0", "I")
                  AddPinFunction(6, "ADC3", "I")
                  AddPinFunction(8, "ADC2", "I")
              ...
              Case 8
                ...
                If ChipFamily = 121 then
                  ...
                  AddIOPin(.PinList(), 2, "PA0")
                  AddIOPin(.PinList(), 3, "PA1")
                  AddIOPin(.PinList(), 4, "PA2")
                  AddIOPin(.PinList(), 5, "PB1")
                  AddIOPin(.PinList(), 6, "PB2")
                  AddIOPin(.PinList(), 7, "PB3")
                  AddIOPin(.PinList(), 8, "GND")

                  AddPinFunction(4, "RESET", "I")
                  AddPinFunction(2, "TPISCK", "IO")
                  AddPinFunction(3, "TPIDATA", "IO")
              ...
              Case 14
                ...
                If ChipFamily = 121 then
                  ...
                  AddIOPin(.PinList(), 3, "PA1")
                  AddIOPin(.PinList(), 4, "PA2")
                  AddIOPin(.PinList(), 5, "PA3")
                  AddIOPin(.PinList(), 6, "PA4")
                  AddIOPin(.PinList(), 7, "PA5")
                  AddIOPin(.PinList(), 8, "PA6")
                  AddIOPin(.PinList(), 9, "PA7")
                  AddIOPin(.PinList(), 10, "PB0")
                  AddIOPin(.PinList(), 11, "PB1")
                  AddIOPin(.PinList(), 12, "PB2")
                  AddIOPin(.PinList(), 13, "PB3")
                  AddIOPin(.PinList(), 14,"GND")
                  ...
                  If ChipADC = 8 then
                       AddPinFunction(2, "ADC0", "I")
                       AddPinFunction(3, "ADC1", "I")
                       AddPinFunction(7, "ADC2", "I")
                       AddPinFunction(8, "ADC3", "I")
                       AddPinFunction(10, "ADC4", "I")
                       AddPinFunction(11, "ADC5", "I")
                       AddPinFunction(12, "ADC6", "I")
                       AddPinFunction(13, "ADC7", "I")
                  End if
                end if
...
Sub ReadXml6 (FileName As String)
  ...
  Dim As String RegBitName, DeviceString
  ...
  Else
    ...
    DeviceString = Device->Attribute("name")
    If Device = 0 Then
        ...
        If RegGroup <> 0 Then
          ...
          For CurrRegister = 0 To RegGroup->Children("register")
            ...
            If Register <> 0 Then
              ...
              'print RegLoc
              'If RegLoc > 32  OR ( GPR16Check( FileName, DeviceString )  = -1 ) Then
              If RegLoc > 32  Then
                'First registers get addresses 0-63 (IO space)
                'Subsequent ones get 96 and up (RAM space)
                If RegLoc < 96 AND ( GPR16Check( FileName, DeviceString )  = 0 ) Then
                    RegLoc -= 32
                End if
...
'    PRINT   "[Registers]"
'    FOR PD = 1 to SVC
'        PRINT  SysVars(PD).Name + "," + Str(SysVars(PD).Loc)
'
'    NEXT
...
Function GPR16Check ( FileName As String , Device as String ) as Integer
